//+------------------------------------------------------------------+
//|  Trend + Pullback · Intraday · Forex
//|  Generato automaticamente da FTMO Strategy App
//|  Tipo strategia: trend_pullback
//+------------------------------------------------------------------+
// Trend + Pullback · Intraday · Forex
//
// Strategia trend + pullback intraday su Forex (major), calibrata per una
// challenge FTMO da $100,000 in fase 1. Rischio 1.0% per trade (medium), massimo
// 3 trade/giorno. Obiettivo: raggiungere il target del 10% restando entro il -5%
// giornaliero e -10% complessivo.
//
// Regole di ingresso:
//   1. Identifica il trend su H4 con EMA50 vs EMA200 (rialzista se EMA50 > EMA200).
//   2. Passa sul timeframe operativo M15/H1 e attendi un pullback verso EMA20.
//   3. Conferma il rientro con candela di reversal (engulfing/pin bar) nella direzione del trend.
//   4. Ingresso al break del massimo/minimo della candela di conferma.
//   5. Stop loss oltre lo swing recente; take profit a 2R (minimo 1:2 RR).
//+------------------------------------------------------------------+
