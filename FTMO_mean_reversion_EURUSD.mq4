//+------------------------------------------------------------------+
//|  Mean Reversion · Intraday · Forex
//|  Generato automaticamente da FTMO Strategy App
//|  Tipo strategia: mean_reversion
//+------------------------------------------------------------------+
// Mean Reversion · Intraday · Forex
//
// Strategia mean reversion intraday su Forex (major), calibrata per una
// challenge FTMO da $100,000 in fase 2. Rischio 0.5% per trade (low), massimo 3
// trade/giorno. Obiettivo: raggiungere il target del 5% restando entro il -5%
// giornaliero e -10% complessivo.
//
// Regole di ingresso:
//   1. Mercato in range: ADX < 20 e prezzo tra le bande di Bollinger(20,2).
//   2. Ingresso long al tocco della banda inferiore con RSI(14) < 30.
//   3. Ingresso short al tocco della banda superiore con RSI(14) > 70.
//   4. Conferma con divergenza o candela di rifiuto.
//   5. Take profit sulla media mobile centrale; stop oltre la banda.
//+------------------------------------------------------------------+
...
input double MinRR            = 1.5;      // Risk:Reward minimo (TP = SL * RR)
